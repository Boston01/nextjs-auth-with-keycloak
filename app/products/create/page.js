...
export default function CreateProduct() {
  ...
  if (status == "loading") {
    return (
      <main>
        <h1 className="text-4x1 text-center">Create product</h1>
    ...
    return (
      <main>
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          ...
          <button type="submit" className="mt-3 bg-blue-900 font-bold text-white py-1 px-2 rounded border border-gray-50">Create</button>
        </form>
      </main>
    );
  }
